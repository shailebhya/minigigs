...
//if gig . accepted by someone and completed at is not null then status is ongoing
  ...
  Widget build(BuildContext context) {
    return GetBuilder<HomeCtrl>(
      id:historyListId,
      builder: (_) {
        return _.historyGigsLoading?Center(child: CircularProgressIndicator(color: Colors.black,)): Scaffold(
          appBar: AppBar(
          ...
          body:_.historyGigs.isEmpty?const Center(child: Text("let's make some history 😁")): ListView.builder(
