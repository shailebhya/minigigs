...
//if gig . accepted by someone and completed at is null then status is ongoing
  ...
  Widget build(BuildContext context) {
    return GetBuilder<HomeCtrl>(
        id: ongoingListId,
        builder: (_) {
          return _.ongoingGigsLoading?const Center(child: CircularProgressIndicator()): Scaffold(
            appBar: AppBar(
            ...
            body:_.ongoingGigs.isEmpty?const Center(child: Text("let's create a gig or find one!")): ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Padding(
                    ...
                    child: InkWell(
                        onTap: () {
                          Get.to(() => OngoingItemView(_.ongoingGigs[index]));
                        },
