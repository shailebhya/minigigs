        ...
        builder: (_) {
          return Scaffold(
            floatingActionButton: FloatingActionButton.extended(
                onPressed: () {
                  Share.share('check out this gig website https://minigigs.in');
                },
            ...
            body: Stack(
              children: [
                SmartRefresher(
                  ...
                  onRefresh: () async {
                    if (widget.gigModel.id != null) {
                      GigModel? temp = await _.getGig(widget.gigModel.id!);
                      temp == null
                          ? Get.snackbar(
                              'something went wrong', 'please try again')
                          : widget.gigModel = temp;
                    }
                    _.update([jobDetailsId]);
                  },
                  child: Container(
                      ...
                      child: ListView(children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              '\u{20B9}' +
                                  widget.gigModel.baseAmount.toString(),
                              style: const TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                                child: Text(
                                    widget.gigModel.location ?? "remote",
                                    style: const TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 15))),
                          ],
                        ...
                        widget.gigModel.acceptedBy!.id != _.authCtrl.user.id ||
                                widget.gigModel.impData!.isEmpty
                            ? const SizedBox()
                            : Container(
                                decoration: BoxDecoration(
